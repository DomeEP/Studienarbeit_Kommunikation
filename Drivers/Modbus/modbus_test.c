/**
 * @file modbus_test.c
 * @brief Offline self-test for the Modbus library
 *
 * Verifies CRC calculation and frame processing without hardware.
...
void Modbus_RunSelfTest(void) {
    ...
    Modbus_Init(&hmodbus_test, &huart_test, &htim_test, 1);
    printf("[PASS] Initialization\n");

    /* Simulate FC03: Slave 1, read 2 registers at address 0x0000 */
    ...
    hmodbus_test.frame_complete = true;
